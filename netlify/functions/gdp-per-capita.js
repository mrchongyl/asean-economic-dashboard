exports.handler = async (event) => {
  ...
  const url = `https://data360api.worldbank.org/data360/data?DATABASE_ID=WB_WDI&INDICATOR=WB_WDI_NY_GDP_PCAP_CD&REF_AREA=${country}&timePeriodFrom=${start_year}&timePeriodTo=${end_year}&skip=0`;
