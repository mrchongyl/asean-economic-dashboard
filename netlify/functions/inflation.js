exports.handler = async (event) => {
  ...
  const url = `https://data360api.worldbank.org/data360/data?DATABASE_ID=WB_WDI&INDICATOR=WB_WDI_FP_CPI_TOTL_ZG&REF_AREA=${country}&timePeriodFrom=${start_year}&timePeriodTo=${end_year}&skip=0`;
